...
const { getTweetId, getTweetSenderHandle, getTweetText } = require('../../helper/tweet')
const { getWelcomeMsg, getErrorFriendMsg, getGeneralInfoMsg } = require('../messages')
...
const extractUserIds = pipe(splitWords, filterNonUserIds, mapTrim, mapRemoveAtSign)
