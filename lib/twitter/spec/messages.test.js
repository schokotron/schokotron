...
describe('helper: messages', () => {
  ...
  describe('getWelcomeMsg()', () => {
    test('it returns correct message', () => {
      expect(getWelcomeMsg('Gunnar_Stenzel', 'davidbeermann')).toEqual(
        'Welcome! @Gunnar_Stenzel is now part of the elect circle of chocolaty calory connoisseurs at XING. @davidbeermann'
      )
    })
  })
